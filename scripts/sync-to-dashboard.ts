...
// Parser extracted to src/pipeline/blueprint-parse.ts (unit-tested, type-checked).
// Re-exported here for existing consumers (pipeline-generate.ts imports from this file).
import { parseBlueprintMarkdown, type BlueprintParseResult } from '../src/pipeline/blueprint-parse.js';
export {
  parseBlueprintMarkdown,
  type ArchPage,
  type BlueprintParseWarning,
  type BlueprintParseResult,
} from '../src/pipeline/blueprint-parse.js';
