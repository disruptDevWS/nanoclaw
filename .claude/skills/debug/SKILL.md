...
**Docker mount syntax:**
- `-v host:container` for read-write
- `-v host:container:ro` for readonly
- Supports both file and directory mounts
...
echo -e "\n3. Docker running?"
docker info &>/dev/null && echo "OK" || echo "NOT RUNNING - start Docker; check logs"
